...
var fight = function (enemy) {
    ...
    while(playerInfo.health> 0 && enemy.health > 0) {
     ...
     var shop = function() {
         var shopOptionPrompt = window.prompt("Would you like to REFILL your health, UPGRADE your attack, or LEAVE the store? Please enter one 1 for REFILL, 2 for UPGRADE, or 3 to LEAVE shop.");
